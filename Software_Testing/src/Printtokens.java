...
public class Printtokens{
	...
	char unget_char (int ch,BufferedReader br) { 
	  try {
		...
		e.printStackTrace();
		 ...
		 return (char)ch; // BUG FIXED HERE RETURN THE CHARRRR!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
	}
	...
	{ 
	  ...
	  StringBuilder sb = new StringBuilder();
	   ...
	   if(ch =='"')id=1;    /* prepare for string */ // BUGGGGGGGGGGGGGGGGGGGGGGG!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
	...
	{
	  if (str.length() == 2 && str.charAt(0)=='#' && Character.isLetter(str.charAt(1))) // BUGGGGSSSSSSSSSSSS HEREEEEEEEEEEE!!!!!!!!!!!!
	     return true;
	  else  
	     return false;
	}
	...
	static boolean is_num_constant(String str)
	{
	  ...
	  if ( Character.isDigit(str.charAt(0))) 
		...
		while ( i < str.length() && str.charAt(i) != '\0' )  
	      {
		   if(Character.isDigit(str.charAt(i)))// BUGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGG!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
	         i++;
	       else
	         return false;
	      }                         /* end WHILE */
	...
	/* OUTPUT:      a BOOLEAN value      */
	/*************************************/
	static boolean is_str_constant(String str) // BUGGGGGGGGGGGGGGGGGGGGGGGGGGGGGG!!!!!!! FIXED HEREEEEEEEEEEE!!!!!!
	{
	    ...
	    for (int i = 1; i < str.length(); i++) {
	        if (str.charAt(i) == '"') {
	            // Only valid if " is the LAST character
	  ...
	  if ( Character.isLetter(str.charAt(0)) ) 
	     {
		    ...
		    return true; // BUGGGGGGGGGGGGGGGGGGGGGGGGGGGG!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
	     }
	  else
		return false; // In here to changed to from true to false 
	}
	...
	static boolean is_spec_symbol(char c)
	{
	    ...
	    if (c == '/')//NOT A SPECIAL SYMBOL!!!!! BUGGGGGGGGGGGGG!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
	    {
	        return true;
	    }
	    if (c == '`')
	    ...
	    if(c == '\'')//= BUGGGGGGGGGGGGGGGGGGGG ADDED QUOTEEEEEEEEEEEEEEEEEEEE!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
	    {
	    	return true;
	    }
